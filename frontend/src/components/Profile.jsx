...
const Profile = () => {
  ...
  return (
    <div>
      ...
      {log ? <Navigate to={'/'}/> :
      <div className='h-[91vh] flex flex-col w-full bg-doodle bg-repeat pl-12 pr-12 pb-12'>
        <div className='rounded-lg bg-[rgb(23,23,23)] mt-12 w-full text-white flex flex-col pb-[5vh]' >
